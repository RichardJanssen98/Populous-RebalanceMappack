...
local ReincPos = {
  MAP_XZ_2_WORLD_XYZ(108, 46), -- Team 1
  MAP_XZ_2_WORLD_XYZ(116, 66), -- Team 1
  MAP_XZ_2_WORLD_XYZ(112, 150), -- Team 1
  MAP_XZ_2_WORLD_XYZ(124, 150), -- Team 1

  MAP_XZ_2_WORLD_XYZ(8, 172), -- Team 2
  MAP_XZ_2_WORLD_XYZ(14, 192), -- Team 2
  MAP_XZ_2_WORLD_XYZ(0, 96), -- Team 2
  MAP_XZ_2_WORLD_XYZ(244, 96)  -- Team 2
}
